                        ...
                        <Dialog.Container visible={this.state.dialogVisible1}>
                            ...
                            <View style={{ marginLeft: 10 }}>
                                ...
                                <View style={{ flexDirection: 'row', marginBottom: 10 }}>
                                    ...
                                    <Text style={styles.radioText}>외식</Text>
                                    <TouchableOpacity
                                        style={styles.radioCircle}
                                        onPress={() => {
                                            this.setState({
                                    ...
                                    <Text style={styles.radioText}>직접 조리</Text>
                                </View>
                    ...
                    <Container style={style.container}>
                        ...
                        <Content style={{ backgroundColor: 'white' }}>
                            ...
                            <View style={{ flexDirection: 'row', marginBottom: 3 }}>
                                <Icon name='md-search' style={{ fontSize: 13, color: 'red', paddingLeft: 10, paddingRight: 5 }} ></Icon>
                                <View style={{ flex: 1 }}><Text style={{ color: "grey" }}>{this.state.text}</Text></View>
                            </View>
                            {
            ...
            return (
                <View style={style.container}>
                    <Container style={style.container}>
                        ...
                        <Content style={{ backgroundColor: 'white' }}>
                            <Text style={{ fontSize: 20, color: "black", marginTop: 15, marginBottom: 3, marginLeft: 10, fontWeight: "bold" }}>오늘의 추천식단</Text>
                            <Text style={{ color: "grey", marginBottom: 15, marginLeft: 10 }}>{this.state.text}</Text>
                            {
