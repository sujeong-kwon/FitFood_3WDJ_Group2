...
export default class CardView2 extends React.Component {
  ...
  onButtonPress = (data) => {
    var postData = {
      breakfast_id: data[0],
      breakfast_name: data[2],
      breakfast_image: data[1],
      lunch_id: data[3],
      lunch_name: data[5],
      lunch_image: data[4],
      dinner_id: data[6],
  ...
  render() {
    ...
    return (
      <Card style={{ marginLeft: 20, marginRight: 20 }}>
        {/* 아침 안 먹었을 경우 카드뷰 */}
        <CardItem cardBody>
          <Body style={{ marginLeft: 7, marginTop: 10 }}>
            <TouchableOpacity
              style={{ flex: 1 }}
              onPress={() => {
                if (Number(data[0]) > 0) {
            ...
            <View style={{ marginTop: 5 }}>
              <Text style={{ fontSize: 13, fontWeight: "bold" }}>{data[2]}</Text>
            </View>
          </Body>
          <Body style={{ marginLeft: 3, maringRight: 3, marginTop: 10 }}>
            <TouchableOpacity
              style={{ flex: 1 }}
              onPress={() => {
                if (Number(data[3]) > 0) {
            ...
            <View style={{ marginTop: 5 }}>
              <Text style={{ fontSize: 13, fontWeight: "bold" }}>{data[5]}</Text>
            </View>
          </Body>
          <Body style={{ marginTop: 10 }}>
            ...
            <View style={{ marginTop: 5 }}>
              <Text style={{ fontSize: 13, fontWeight: "bold" }}>{data[8]}</Text>
            </View>
          </Body>
        </CardItem>
        <CardItem style={{ flexDirection: 'row' }}>
          <Icon
            ...
            onPress={() => this.onButtonPress(data)}
            size={13}
