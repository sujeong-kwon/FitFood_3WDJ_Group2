...
export default {
  ...
  // created : function(){
    ...
    .then(res => {
      ...
      // console.log(this.name); // 각 칸에 store_name으로 저장돼있는 것 확인
      // console.log(this.store_gps_Lat);
      // console.log(this.store_gps_Lng);
    ...
    for (let i = 0; i < this.name.length; i++){
      ...
      // position_ = {
      //   store_name: this.name[i].store_name,
      //   store_gps: new kakao.maps.LatLng(this.store_gps_Lat[i].store_gps_latitude, this.store_gps_Lng[i].store_gps_longitude)
      // }
      positions[i] = {
      ...
      // positions.push(store_name = this.name[i].store_name, store_gps = new kakao.maps.LatLng(this.store_gps_Lat[i].store_gps_latitude, this.store_gps_Lng[i].store_gps_longitude));
    }
