    ...
    <v-card class="mx-auto" min-width="344">
      <v-card-title>
        ...
        <v-menu bottom left transition="scale-transition">
          ...
          <v-list>
            <v-list-item>
              <v-btn small class="float-right ma-2" tile outlined color="error">
      ...
      <v-card-text class="font-weight-bold">{{ item.review_context }}</v-card-text>
