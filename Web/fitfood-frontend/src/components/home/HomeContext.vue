          ...
          <div
            ...
            <v-container>
              <v-layout column align-center text-xs-center>
                ...
                <div class="headline font-weight-bold info--text mb-4">gg</div>
                <div class="black--text">gg</div>
              </v-layout>
            </v-container>
          </div>
        </v-flex>
...
<div class="service grey lighten-4">
...
<script>
  export default {
    data(){
      return {
        service : [
          { img : '/static/main2_4.png', title : '영양소 분석 그래프',
          text : 'graph'
          },
          { img : '/static/main2_2.png',title : '음식점, 음식 추천 & 레시피 제공', 
          ...
          { img : '/static/main2_3.png', title : '리뷰 게시판', 
