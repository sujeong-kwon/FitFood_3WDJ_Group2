...
class App extends React.Component {
    ...
    get_EatenData(day) {
        ...
        const data = new FormData();
        data.append('user_email', 'tester@tester.com');
        data.append('date', day.dateString);
        fetch('http://ec2-52-72-52-75.compute-1.amazonaws.com/eaten_data',
            { method: 'POST', body: data }
        )
                ...
                <Tabs>
                    <Tab heading={<TabHeading style={{ backgroundColor: '#1fa518' }}>
                        ...
                        <View style={{ marginTop: 80 }}>
                            ...
                            />
                            {/* <Dialog.Container visible={this.state.dialogVisible}>
                                <Dialog.Title style={{ textAlign: 'center', fontWeight: 'bold' }}>{this.state.day ? String(this.state.day.dateString) : null}</Dialog.Title>
                                <View>
                                ...
                                <Dialog.Button style={{ textAlign: 'center', height: 40, color: "black" }} label="취소" onPress={this.handleDelete} />
                            </Dialog.Container> */}
                        </View>
                    </Tab>
                    <Tab heading={<TabHeading style={{ backgroundColor: '#1fa518' }}>
