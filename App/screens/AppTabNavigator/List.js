...
import { Container, Content, Icon, Button, Header, Body } from 'native-base'; //
            ...
            return (
                <View style={style.container}>
                    <Container style={style.container}>
                        ...
                        <Content>
                            <Text style={{ fontSize: 25, color: "#1fa518", textAlign: 'center', marginTop: 10, marginBottom: 10, fontWeight: "bold" }}>오늘의 추천식단</Text>
                            <CardView />
                            <CardView />
                            <CardView />
                        </Content>
